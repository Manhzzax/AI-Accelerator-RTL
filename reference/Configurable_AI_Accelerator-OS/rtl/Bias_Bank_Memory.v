...
module Bias_Bank_Memory #(
    ...
    assign arbiter_mem_addr_w    = arbiter_BM_waddr_i[MEM_AWIDTH-1:0];
    ...
    Dual_Port_BRAM #(
        ...
        .CLK           (CLK),
        .port_a_en_i   (arbiter_BM_wvalid_i),
        .port_a_we_i   (arbiter_BM_wvalid_i),
        .port_a_addr_i (arbiter_mem_addr_w),
        .port_a_data_i (arbiter_BM_wdata_i[(DWIDTH*1)-1:(DWIDTH*0)]),
        .port_a_data_o (),
    ...
    Dual_Port_BRAM #(
        ...
        .port_a_we_i   (arbiter_BM_wvalid_i),
        .port_a_addr_i (arbiter_mem_addr_w),
        .port_a_data_i (arbiter_BM_wdata_i[(DWIDTH*2)-1:(DWIDTH*1)]),
        .port_a_data_o (),
    ...
    Dual_Port_BRAM #(
        ...
        .port_a_we_i   (arbiter_BM_wvalid_i),
        .port_a_addr_i (arbiter_mem_addr_w),
        .port_a_data_i (arbiter_BM_wdata_i[(DWIDTH*3)-1:(DWIDTH*2)]),
        .port_a_data_o (),
    ...
    Dual_Port_BRAM #(
        ...
        .port_a_we_i   (arbiter_BM_wvalid_i),
        .port_a_addr_i (arbiter_mem_addr_w),
        .port_a_data_i (arbiter_BM_wdata_i[(DWIDTH*4)-1:(DWIDTH*3)]),
        .port_a_data_o (),
