...
def main():
    ...
    if not args.checkpoint or not os.path.isfile(args.checkpoint):
        ...
        print()
        print("STATUS: Awaiting trained checkpoint (.pt) and final PTQ calibration table.")
        print("Note: The current parameters in manifest.json are STUB / TEMPLATE placeholders.")
        print()
